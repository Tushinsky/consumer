...
/**
 *
 * @author http://www.crionics.com/products/opensource/faq/swing_ex/SwingExamples.html
 * @version 1.0 11/26/98
 */
public class MultiSpanCellTableEx extends JTable {
    
    public MultiSpanCellTableEx(TableModel model) {
        super(model);
    ...
    public void setModel(TableModel tm) {
        super.setModel(tm); //To change body of generated methods, choose Tools | Templates.
    }
