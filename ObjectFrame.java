...
//        System.out.println("getturnObjects idObject=" + idObject);
        ...
        if(idObject != 0){
            // если есть код объекта, получаем информацию по его отключению/подключению
            ...
            // заполняем таблицу пустыми данными
//            mtModel = new MDIObject.MyTableModelImpl(new Object[][]{new Object[]{"","","","","","","",""}}, 
//                    objectTurnDao.getColumnName(), objectTurnDao.getColumnClass());
//            MDIObject.fullTableData(new int[]{0,1,2,3,4,5,6,7}, mtModel, tblTurnObject);
...
//    }
    /**
     * 
     * @param tdi объект доступа к данным (поставщик данных)
     * @param colIndex массив нередактируемых столбцов
     * @param defaultcolIndex массив нередактируемых столбцов, заданных по умолчанию
     * @param defaultContent массив данных по умолчанию
     * @param table таблица для вывода данных
     * @param propertyname имя свойства из файла свойств, содержащее строку с шириной столцов
     * @param colListener слушатель изменений ширины столбцов
     * @return модель данных для заполнения таблицы
     */
