 ...
 * @author Сергей
 */
public class MidpressloseDaoImpl extends TableDaoImpl{

    private String tableName = "MIDPRESSLOSE";

    public MidpressloseDaoImpl(int idObject) {
        super(idObject);
    ...
    @Override
    public Midpresslose getItem(int ID) {
        TableEntity entity = super.getItem(ID);
        Midpresslose midpress = new Midpresslose(entity.getId(), entity.getIndex());
        return midpress;
    }
